...
**Todos obrigatórios para qualificar o candidato; provas ainda NOT_RUN neste programa.** Aceitar somente resultados vinculados ao mesmo candidato. Teste ausente ou infraestrutura indisponível gera bloqueio, nunca PASS. As tarefas listadas produzem a evidência; PROD-40 inspeciona independentemente.
