...
Recibo claim/complete/fail corrigido; 9/9 com exit 0 apos F4. Gateway real segue BLOCKED externo.

**Sinal de conclusão da ação:** Critico reproduz falha pos-HMAC + retry com um efeito; contrato Gateway permanece BLOCKED com dono.
...
Evidências: evidencias/prod-07/relatorio.md, evidencias/prod-07/PROCEDIMENTO-RECUPERACAO.md
