...
**Fonte canônica:** [BACKLOG.json](BACKLOG.json). Revisão R3: preserve as entregas descritas em cada cartão. Status deste ciclo começa PLANNED; checks NOT_RUN/TO_CREATE exigem descoberta e execução segura. As evidências recebidas são históricas.

| Tarefa | Prioridade | Marco | Pontos restantes | Dependências |
|---|---|---|---|---|
| [PROD-00 — Congelar candidato e ambiente de teste reproduzível](tasks/PROD-00.md) | P1 | M0 | 3 | — |
| [PROD-01 — Fechar contratos e decisões de escopo/produção](tasks/PROD-01.md) | P1 | M0 | 3 | PROD-00 |
| [PROD-02 — Corrigir gate mestre e vínculo de evidência ao candidato](tasks/PROD-02.md) | P0 | M0 | 8 | PROD-00 |
| [PROD-03 — Corrigir agregador e política required PR/release/scheduled](tasks/PROD-03.md) | P0 | M0 | 5 | PROD-01, PROD-02 |
| [PROD-04 — Uniformizar permissão de ação e escopo em HTTP/WS](tasks/PROD-04.md) | P0 | M1 | 5 | PROD-01 |
| [PROD-05 — Provar sessão, rotação e revalidação HTTP/WS](tasks/PROD-05.md) | P0 | M1 | 3 | PROD-01, PROD-06, PROD-44 |
| [PROD-06 — Harmonizar schema e timezone; preparar evolução relacional](tasks/PROD-06.md) | P1 | M1 | 3 | PROD-01 |
| [PROD-07 — Tornar recibo de webhook recuperável sem enfraquecer antirreplay](tasks/PROD-07.md) | P0 | M1 | 5 | PROD-01, PROD-06 |
| [PROD-08 — Eliminar conversas órfãs e duplicatas no primeiro inbound](tasks/PROD-08.md) | P0 | M1 | 3 | PROD-07 |
| [PROD-09 — Garantir efeitos idempotentes de worker e falhas observáveis](tasks/PROD-09.md) | P0 | M1 | 5 | PROD-08 |
| [PROD-10 — Mover Secretary para execução durável assíncrona](tasks/PROD-10.md) | P0 | M1 | 8 | PROD-09 |
| [PROD-11 — Validar reconciliação outbound e retenção da intenção](tasks/PROD-11.md) | P1 | M1 | 3 | PROD-08, PROD-10 |
| [PROD-12 — Provar leases, DLQ e fanout entre processos](tasks/PROD-12.md) | P1 | M1 | 5 | PROD-04, PROD-09, PROD-11 |
| [PROD-13 — Fechar budget durável e workflow seguro de ferramentas IA](tasks/PROD-13.md) | P1 | M1 | 5 | PROD-01, PROD-10, PROD-04 |
...
| [PROD-16 — Fechar escopo de privacidade e política por cópia](tasks/PROD-16.md) | P0 | M1 | 8 | PROD-01, PROD-06 |
| [PROD-17 — Validar sessão inicial e navegação por capacidade](tasks/PROD-17.md) | P1 | M2 | 3 | PROD-04, PROD-05 |
| [PROD-18 — Completar APIs operacionais transacionais e trilha de auditoria](tasks/PROD-18.md) | P0 | M2 | 5 | PROD-04, PROD-08, PROD-09 |
...
| [PROD-36 — Fechar boot, health/readiness e implantação remota](tasks/PROD-36.md) | P0 | M3 | 5 | PROD-00, PROD-04, PROD-05, PROD-12 |
...
| [PROD-40 — Auditoria independente final do candidato integrado](tasks/PROD-40.md) | P1 | M5 | 8 | PROD-00, PROD-01, PROD-02, PROD-03, PROD-04, PROD-05, PROD-06, PROD-07, PROD-08, PROD-09, PROD-10, PROD-11, PROD-12, PROD-13, PROD-14, PROD-15, PROD-16, PROD-17, PROD-18, PROD-19, PROD-20, PROD-21, PROD-22, PROD-23, PROD-24, PROD-25, PROD-26, PROD-27, PROD-28, PROD-29, PROD-30, PROD-31, PROD-32, PROD-33, PROD-34, PROD-35, PROD-36, PROD-37, PROD-38, PROD-39, PROD-44 |
...
| [PROD-44 — Restaurar bootstrap nativo realtime na fronteira ESM/CommonJS](tasks/PROD-44.md) | P0 | M0 | 3 | PROD-00 |
