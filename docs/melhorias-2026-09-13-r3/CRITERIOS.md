...
## Regressões obrigatórias R3

G01 exige rejeitar números inválidos/excedentes/tempo futuro e ausência de runId/attempt também em artefato derivado. G02/G09/G10 exigem boot nativo e matriz HTTP de métricas; PROD-44 entrega a correção inicial e PROD-36/35 a imagem real. G03 exige recuperação explícita de processing órfão; G04 exige progresso de pool10/lote50 em PG real. Preservar negativos R2 já corrigidos. Toda prova nova deve registrar esses casos e a identidade do candidato.
