# Instruções para o agente — revisão R2
...
2. Execute `python3 docs/melhorias-2026-09-13/plan.py validate`. Esse check só valida o plano.
...
`python3 docs/melhorias-2026-09-13/plan.py render` atualiza cartões/índices. Registrar resultados em evidencias e apontar os arquivos em evidence_refs. A observação da auditoria é baseline histórica, não status de execução. Atualize a narrativa e decisões com data; preserve evidências de falhas.
