...
**Fonte canônica:** [BACKLOG.json](BACKLOG.json). Revisão R2: preserve as entregas descritas em cada cartão. Status deste ciclo começa PLANNED; checks NOT_RUN/TO_CREATE exigem descoberta e execução segura. As evidências recebidas são históricas.
...
| [PROD-05 — Provar sessão, rotação e revalidação HTTP/WS](tasks/PROD-05.md) | P1 | M1 | 3 | PROD-01, PROD-06 |
...
| [PROD-18 — Completar APIs operacionais transacionais e trilha de auditoria](tasks/PROD-18.md) | P1 | M2 | 5 | PROD-04, PROD-08, PROD-09 |
...
| [PROD-36 — Fechar boot, health/readiness e implantação remota](tasks/PROD-36.md) | P1 | M3 | 5 | PROD-00, PROD-04, PROD-05, PROD-12 |
