...
## Achados da auditoria de entregas

| Achado | Tarefas responsáveis |
|---|---|
| BE-A01 — Secretary reabre estado unknown e refaz chamada externa | [PROD-10](tasks/PROD-10.md), [PROD-12](tasks/PROD-12.md), [PROD-13](tasks/PROD-13.md) |
| BE-A02 — Retry de webhook com timestamp renovado é rejeitado como payload diferente | [PROD-07](tasks/PROD-07.md) |
| BE-A03 — Duplicata já commitada ainda recebe 409 contra o contrato C03 | [PROD-01](tasks/PROD-01.md), [PROD-07](tasks/PROD-07.md) |
| BE-A04 — Recuperação de mídia não é acionada pelo runtime e exclui SCAN_FAILED | [PROD-14](tasks/PROD-14.md) |
| BE-A05 — Endpoint legado de anonimização contorna política e escopo de mutação | [PROD-04](tasks/PROD-04.md), [PROD-16](tasks/PROD-16.md) |
| BE-A06 — CAS é opcional e cliente atual não envia versão | [PROD-18](tasks/PROD-18.md), [PROD-19](tasks/PROD-19.md), [PROD-27](tasks/PROD-27.md) |
| OPS01 — Digest esperado é ignorado na reavaliação | [PROD-02](tasks/PROD-02.md), [PROD-35](tasks/PROD-35.md) |
| OPS02 — Manifesto contraditório com log vazio recebe PASS | [PROD-02](tasks/PROD-02.md), [PROD-34](tasks/PROD-34.md) |
| OPS03 — Query-performance sem medição recebe PASS | [PROD-02](tasks/PROD-02.md), [PROD-33](tasks/PROD-33.md) |
| OPS04 — Evento desconhecido cai silenciosamente em push | [PROD-03](tasks/PROD-03.md) |
| OPS05 — Smoke real MinIO não consegue provar delete | [PROD-32](tasks/PROD-32.md) |
| OPS06 — Prova de imagem identifica build local, sem ligação com boot/scan/entrega | [PROD-03](tasks/PROD-03.md), [PROD-35](tasks/PROD-35.md), [PROD-38](tasks/PROD-38.md) |
| OPS07 — Conjunto entregue não sela candidato atual | [PROD-00](tasks/PROD-00.md), [PROD-36](tasks/PROD-36.md), [PROD-40](tasks/PROD-40.md) |
| OPS08 — DR usa bancos fixos destrutivos e prova de fixture insuficiente | [PROD-37](tasks/PROD-37.md) |
| DOC01 — Documentação e metadados de execução contradizem as entregas | [PROD-00](tasks/PROD-00.md), [PROD-01](tasks/PROD-01.md), [PROD-39](tasks/PROD-39.md) |
| FE01 — Drawer fechado amplia Inbox 1024 para 1318 pixels e continua no DOM acessível | [PROD-29](tasks/PROD-29.md) |
| FE02 — Operação no contexto incompleta: transferência desabilitada; cadastro abre lista genérica | [PROD-19](tasks/PROD-19.md) |
| FE03 — Busca e contagens consideram apenas conversas carregadas; parâmetros de consulta não incluem busca/status/responsável/labels | [PROD-19](tasks/PROD-19.md) |
| FE04 — Timeline rotula qualquer histórico como Hoje | [PROD-20](tasks/PROD-20.md) |
| FE05 — asset:// é chip sem ação; documento/vídeo não têm componente de leitura completo | [PROD-20](tasks/PROD-20.md) |
| FE06 — Rascunhos e intenções existem só em memória do Inbox; sair/remontar perde estado | [PROD-20](tasks/PROD-20.md) |
| FE07 — Tarefa não permite atribuição/vínculos no formulário nem abrir conversa do card | [PROD-21](tasks/PROD-21.md) |
| FE08 — Nota exige ID técnico e apresenta referência truncada sem navegação | [PROD-22](tasks/PROD-22.md) |
| FE09 — Ficha de contato carrega/cria notas apenas na primeira conversa | [PROD-22](tasks/PROD-22.md), [PROD-25](tasks/PROD-25.md) |
| FE10 — Alertas têm ack/resolve mas não navegam ao recurso relacionado | [PROD-23](tasks/PROD-23.md) |
| FE11 — Grupos só exibem membros; instrução para adicionar pela ficha não corresponde a controle ali | [PROD-24](tasks/PROD-24.md) |
| FE12 — Paciente ainda usa tutorId singular; N:N não representado pela UI | [PROD-25](tasks/PROD-25.md) |
| FE13 — Admin não possui editor de permissões por papel/vínculo usuário-papel nem gestão completa de membros de times/filas | [PROD-26](tasks/PROD-26.md) |
| FE14 — Kanban move por select/drag, mas card não abre conversa e só há filtro de setor | [PROD-27](tasks/PROD-27.md) |
| FE15 — Tasks/Alerts/Contacts/Kanban/Dashboard não assinam realtime nem executam polling bounded | [PROD-30](tasks/PROD-30.md) |
| FE16 — Monólitos de página e duplicação de estados continuam; features/inbox ausente | [PROD-28](tasks/PROD-28.md) |
| FE17 — Percurso E2E produção completo não está implementado na pasta de suites | [PROD-38](tasks/PROD-38.md) |
