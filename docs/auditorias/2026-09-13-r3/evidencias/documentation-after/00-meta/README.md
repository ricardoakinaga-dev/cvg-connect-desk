...
> **Atualizado:** 2026-09-13 — auditoria R3

**Referência atual — auditoria R3 e continuidade:** [relatório R3](../auditorias/2026-09-13-r3/RELATORIO.md) e [plano executivo, roadmap e backlog R3](../melhorias-2026-09-13-r3/README.md). Produto NOT_READY; bootstrap realtime falha no processo nativo e os resultados/provas restantes estão discriminados.

**Histórico R2:** [auditoria das entregas](../auditorias/2026-09-13-entregas/RELATORIO.md) e [plano anterior](../melhorias-2026-09-13/README.md), preservados como retrato da rodada anterior.

**Histórico de13/09:** [auditoria inicial](../auditorias/2026-09-13/RELATORIO.md) e [programa executado parcialmente](../producao-2026-09-13/README.md).
...
**Problema conhecido:** os inventários e descrições históricos abaixo podem conter afirmações que não correspondem mais ao código atual. Para estado técnico, prevalecem ARCHITECTURE, TEST_MATRIX, GAPS-TECNICOS e a auditoria R3 vinculada acima. Este mapa ajuda a identificar qual documento consultar para cada necessidade.
...
## 3. Referências operacionais a consultar com a auditoria atual

Os documentos abaixo são referências existentes; suas afirmações precisam ser confrontadas com a auditoria R3 e os documentos centrais atualizados.
...
**Para resultado técnico atual, prevalecem auditoria R3, ARCHITECTURE, TEST_MATRIX, GAPS-TECNICOS e o backlog R3.**
