...
| C08 | Dados e IA | Dados/admin/Secretary → consumidores | Relação tutor–paciente ratificada; budget persistente e ferramentas aprovadas; privacidade e restores compatíveis. |
...
- Erros: 401 `invalid_signature`; 409 `duplicate_event_id`; skew >300s rejeitado.
