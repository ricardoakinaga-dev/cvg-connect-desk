# AAA-31 — Polir administração, auditoria e configurações
...
Status: PLANNED | Responsável: frontend páginas 31 | Fase: 3 | Risco: R2 | Pontos: 5

## Objetivo

Rotas Admin, Audit, Settings usam tokens/contratos congelados e estados reais loading/empty/error/forbidden/success.
...
Locks de recursos: isolated-db:AAA-31, ports:AAA-31
...
- apps/desk-web/src/pages/Audit.css
- apps/desk-web/src/pages/Settings.tsx
- apps/desk-web/src/pages/Settings.css
- apps/desk-web/src/__tests__/aaa-31.test.tsx
...
- `pnpm --filter @cvg/desk-web exec vitest run src/__tests__/aaa-31.test.tsx` — ambiente: browser-mocked
